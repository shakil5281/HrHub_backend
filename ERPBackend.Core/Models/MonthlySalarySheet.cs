...
namespace ERPBackend.Core.Models
{
    public class MonthlySalarySheet
    {
        ...
        [Column(TypeName = "decimal(18,2)")] public decimal OtherAllowances { get; set; }

        [Column(TypeName = "decimal(18,2)")] public decimal TotalEarning { get; set; }

        [Column(TypeName = "decimal(18,2)")] public decimal AbsentDeduction { get; set; }

        [Column(TypeName = "decimal(18,2)")] public decimal AdvanceDeduction { get; set; }

        [Column(TypeName = "decimal(18,2)")] public decimal OTDeduction { get; set; }
        ...
        [Required] [StringLength(20)] public string Status { get; set; } = "Draft"; // Draft, Processed, Approved, Paid

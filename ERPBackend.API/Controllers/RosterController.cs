    ...
    public class RosterController : ControllerBase
    {
            ...
            [FromQuery] string? searchTerm)
        {
            ...
            return await query
                ...
                {
                    Id = r.Id,
                    EmployeeCard = r.EmployeeId,
                    EmployeeId = r.Employee != null ? r.Employee.EmployeeId : string.Empty,
                    ...
                    DepartmentName = (r.Employee != null && r.Employee.Department != null)
                        ...
                        : string.Empty,
                    DesignationName = (r.Employee != null && r.Employee.Designation != null)
                        ? r.Employee.Designation.NameEn
                        : string.Empty,
                    Date = r.Date,
                    ShiftId = r.ShiftId,
        ...
        public async Task<ActionResult<RosterDto>> CreateRoster(CreateRosterDto dto)
        {
            ...
            var existing = await _context.EmployeeShiftRosters
                .FirstOrDefaultAsync(r => r.EmployeeId == dto.EmployeeCard && r.Date.Date == dto.Date.Date);
        ...
        public async Task<IActionResult> CreateBulkRoster(BulkRosterDto dto)
        {
            ...
            foreach (var empId in dto.EmployeeCards)
            {

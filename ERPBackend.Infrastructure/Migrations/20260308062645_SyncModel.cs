        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CMCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    EmbroideryCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    FOBPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    FabricCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    OverheadCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    PackingCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    PrintCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ProfitMargin = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    TrimCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    WashCost = table.Column<decimal>(type: "decimal(18,4)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StyleOrders_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
